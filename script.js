...
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                title: "How to Use Google Maps in Apps"
            }, {
                ...
                title: "Learn how to make Fighting Games"
            }].map((movie) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "Make Intresting Games, Apps and Website" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.youtube.com/channel/UCJZ83gzcryT0GJs6O8KrhGA", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "Code with Anshuman")),
